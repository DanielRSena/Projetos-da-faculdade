...
int main()
	...
	*/
	...
	//	6.	Organizacao de excursoes, com todos os lugares ocupados
	/*{
	...
	//	8. Vetor criado pelo usu�rio, tamanho > 2 e par. Outro vetor guardar� a soma de duas posi��es do primeiro
	/*{
		int t, cont;
		printf("\n\t\t- Somador de vetores - \n\n");
		do {
